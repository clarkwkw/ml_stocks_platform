...
def test():
    ...
    print(MLUtils.evaluateModel(model, valid_data, 10, "long"))

    print("Evaluation short - 10")
    print(MLUtils.evaluateModel(model, valid_data, 10, "short"))

    print("Evaluation long_short - 10")
    print(MLUtils.evaluateModel(model, valid_data, 10, "long_short"))
